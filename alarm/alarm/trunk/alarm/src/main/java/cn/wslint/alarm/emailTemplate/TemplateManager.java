...
public class TemplateManager {
  ...
  static {
    ...
    if (!FileUtil.exist(templateStr)) {
      logger.error(
          "template file is not exist; please add a template file in classpath:template/message.tpl or set the real template file path to alarm.template key");
